...
module.exports = {
    ...
    create_report:function(componentA,componentB){
        ...
        /*função em teste*/
        var intervals_useds=module.exports.load_intervals_useds();
        ...
        for(i=0;i<number_of_phases;i++){
            ...
            /*Objeto Componente*/
            component_A=module.exports.build_component(componentA,i,experiment,lista,intervals_useds,1)
            component_B=module.exports.build_component(componentB,i,experiment,lista,intervals_useds,2)
            phases.push({
    ...
    build_component:function(temp_component,index_phase,experiment,lista,ab){
        ...
        /*alteração*/
        //inseir aqui o vetor de intevalos //fazer
        if(ab==1){
            var intervals=intervals_useds[index_phase].intervals.componentA
        }else{
            var intervals=intervals_useds[index_phase].intervals.componentB  
        }
        ...
        return temp_component={
            ...
            "intervals_useds":""+"["+intervals+"]",
            "color":color
        }
    },
    load_intervals_useds : function(){//função que carrega intevalos usados durante o teste
        /*função em teste*/
        var vi_generate = require('./gera_vi.js');
        intervals=vi_generate.report_intervals();
        return intervals
    },
    /*grava relatorio*/
